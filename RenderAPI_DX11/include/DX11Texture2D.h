...
public:
	// Construct a Texture2D / Texture2DMS / Texture2DArray / Texture2DMSArray depth buffer
...
private:
	void InternalConstruct(ID3D11Device* d3dDevice, int width, int height, UINT bindFlags, int arraySize, int sampleCount, int sampleQuality, D3D11_DSV_DIMENSION dsvDimension, D3D11_SRV_DIMENSION srvDimension, bool stencil);
