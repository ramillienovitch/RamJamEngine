...
Matrix44_T<Real> Matrix44_T<Real>::operator+( const Matrix44_T<Real>& matIn )
{
	...
	matOut.m14 += matIn.m14;
	matOut.m21 += matIn.m21;
	matOut.m22 += matIn.m22;
	matOut.m23 += matIn.m23;
	matOut.m24 += matIn.m24;
	matOut.m31 += matIn.m31;
	matOut.m32 += matIn.m32;
	matOut.m33 += matIn.m33;
	matOut.m34 += matIn.m34;
	matOut.m41 += matIn.m41;
	matOut.m42 += matIn.m42;
	matOut.m43 += matIn.m43;
...
Matrix44_T<Real>& Matrix44_T<Real>::operator=( const DirectX::XMMATRIX& matIn)
{
	...
	m13 = matIn.r[0].m128_f32[2];
	m14 = matIn.r[0].m128_f32[3];
	m21 = matIn.r[1].m128_f32[0];
	m22 = matIn.r[1].m128_f32[1];
	m23 = matIn.r[1].m128_f32[2];
	m24 = matIn.r[1].m128_f32[3];
	m31 = matIn.r[2].m128_f32[0];
	m32 = matIn.r[2].m128_f32[1];
	m33 = matIn.r[2].m128_f32[2];
	m34 = matIn.r[2].m128_f32[3];
	m41 = matIn.r[3].m128_f32[0];
	m42 = matIn.r[3].m128_f32[1];
